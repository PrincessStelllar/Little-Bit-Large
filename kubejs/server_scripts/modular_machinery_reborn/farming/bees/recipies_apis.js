...
const allBees = [
    ...
    ["crystalline", 2, "eternalores:crystalline_block"],
    ["diamond", 2, "eternalores:diamond_block"],
    ["emerald", 2, "eternalores:emerald_block"],
    ...
    ["rose_quartz", 2, "eternalores:rose_quartz_block"],
    ...
    ["shroom\/brown_shroom", 2, "minecraft:brown_mushroom"],
    ["shroom\/crimson", 2, "minecraft:crimson_fungus"],
    ["shroom\/red_shroom", 2, "minecraft:red_mushroom"],
    ["shroom\/warped", 2, "minecraft:warped_fungus"],
    ...
    ["tconstruct\/cobalt", 2, "tconstruct:cobalt"],
    ...
    ["tconstruct\/pig_iron", 2, "eternalores:pig_iron_block"],
    ["tconstruct\/queens_slime", 2, "tconstruct:queens_slime"],
    ["tconstruct\/rose_gold", 2, "eternalores:rose_gold_block"],
