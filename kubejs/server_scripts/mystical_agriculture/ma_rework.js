...
ServerEvents.recipes(catalyst => {
    ...
    let infusionRecipes = [
        ...
        { out: 'mysticalagriculture:mystical_diamond_seeds', in: "mysticalagriculture:prosperity_seed_base", ing: ["eternalores:compressed_diamond_3x", "mysticalagriculture:diamond_seeds", "eternalores:compressed_diamond_3x", "mysticalagriculture:diamond_seeds", "eternalores:compressed_diamond_3x", "mysticalagriculture:diamond_seeds", "eternalores:compressed_diamond_3x", "mysticalagriculture:diamond_seeds"], bee: false },
        { out: 'mysticalagriculture:mystical_emerald_seeds', in: "mysticalagriculture:prosperity_seed_base", ing: ["eternalores:compressed_emerald_3x", "mysticalagriculture:emerald_seeds", "eternalores:compressed_emerald_3x", "mysticalagriculture:emerald_seeds", "eternalores:compressed_emerald_3x", "mysticalagriculture:emerald_seeds", "eternalores:compressed_emerald_3x", "mysticalagriculture:emerald_seeds"], bee: false },
